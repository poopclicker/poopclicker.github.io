(()=>{
    ...
    var r, a, u = (r = window.pokiSDKVersion || e("ab") || "v".concat("2.341.3"),
    a = "poki-sdk-core-".concat(r, ".js"),
    n && (a = "poki-sdk-kids-".concat(r, ".js")),
    t && (a = "poki-sdk-playground-".concat(r, ".js")),
    o && (a = "poki-sdk-hoist-".concat(r, ".js")),
    "/".concat(r, "/").concat(a)), c = document.createElement("script");
    c.setAttribute("src", "/poki-sdk-core-v2.341.3.js"),
