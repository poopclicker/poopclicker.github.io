(()=>{
    var e, t, n, i, o = {
            ...
            !function(n, a) {
                if (n) {
                    ...
                    s.report = function() {
                        ...
                        m.unsubscribe = function(a) {
                            for (var s = r.length - 1; s >= 0; --s)
                                r[s] === a && r.splice(s, 1);
                            0 === r.length && (t && (n.onerror = e,
                            t = !1),
                            o && (n.onunhandledrejection = i,
                            o = !1))
                        }
                        ,
                        m
                    ...
                    s.computeStackTrace = function() {
                        ...
                        function o(e, t) {
                            var n, o = /function ([^(]*)\(([^)]*)\)/, r = /['"]?([0-9A-Za-z$_]+)['"]?\s*[:=]\s*(function|eval|new Function)/, a = "", s = i(e);
                            if (!s.length)
                                return l;
                            for (var d = 0; d < 10; ++d)
                                if (!p(a = s[t - d] + a)) {
                        ...
                        function A(e, t, n) {
                            var o, r = i(t), s = new RegExp("\\b" + a(e) + "\\b");
                            return n -= 1,
                            r && r.length > n && (o = s.exec(r[n])) ? o.index : null
                        }
                        function h(e) {
                            if (!p(n && n.document)) {
                                for (var t, i, o, r, s = [n.location.href], l = n.document.getElementsByTagName("script"), A = "" + e, u = 0; u < l.length; ++u) {
                                    var h = l[u];
                                    h.src && s.push(h.src)
                                }
                                if (o = /^function(?:\s+([\w$]+))?\s*\(([\w\s,]*)\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(A)) {
                                    var m = o[1] ? "\\s+" + o[1] : ""
                                ...
                                if (r = c(i, s))
                                    return r;
                                if (o = /^function on([\w$]+)\s*\(event\)\s*\{\s*(\S[\s\S]*\S)\s*\}\s*$/.exec(A)) {
                                    var v = o[1];
                                    if (t = d(o[2]),
                                    r = c(i = new RegExp("on" + v + "=[\\'\"]\\s*" + t + "\\s*[\\'\"]","i"), s[0]))
                                        return r;
                                    if (r = c(i = new RegExp(t), s))
                                        return r
                                }
                                return null
                            }
                        ...
                        function m(e) {
                            ...
                            for (var t, n, i, a = /^\s*at (.*?) ?\(((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, s = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, d = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, c = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, u = /\((\S*)(?::(\d+))(?::(\d+))\)/, h = e.stack.split("\n"), m = [], g = /^(.*) is undefined$/.exec(e.message), v = 0, f = h.length; v < f; ++v) {
                                if (n = a.exec(h[v])) {
                                    ...
                                    n[4] = t[2],
                                    n[5] = null) : 0 !== v || n[5] || p(e.columnNumber) || (m[0].column = e.columnNumber + 1),
                                    i = {
                                        url: n[3],
                                        func: n[1] || l,
                                        args: n[2] ? n[2].split(",") : [],
                        ...
                        function v(e, t) {
                            for (var n, i, r, a = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, d = [], c = {}, u = !1, p = v.caller; p && !u; p = p.caller)
                                if (p !== f && p !== s.report) {
                                    if (i = {
                                        url: null,
                                        func: l,
                            ...
                            return g(y, e.sourceURL || e.fileName, e.line || e.lineNumber, e.message || e.description),
                            y
                        }
                        function f(t, a) {
                            var s = null;
                                ...
                                if (s = function(e) {
                                    ...
                                    if (t) {
                                        for (var n, i = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i, a = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^\)]+))\((.*)\))? in (.*):\s*$/i, s = t.split("\n"), d = [], c = 0; c < s.length; c += 2) {
                                            ...
                                            l) {
                                                if (!l.func && l.line && (l.func = o(l.url, l.line)),
                                                l.line)
                                                    try {
                                    ...
                                    for (var v = 2; v < t.length; v += 2) {
                                        ...
                                        if (a = s.exec(t[v]))
                                            ...
                                            if (w) {
                                                ...
                                                if (b) {
                                                    var k = (b = b.join("\n")).indexOf(w.innerText);
                                                    k >= 0 && (f.line = y + b.substring(0, k).split("\n").length)
                                                }
                                            }
                                        ...
                                        if (f) {
                                            ...
                                            I && x.replace(/^\s*/, "") === t[v + 1].replace(/^\s*/, "") ? f.context = I : f.context = [t[v + 1]],
                                            p.push(f)
                                        }
                                    }
                                    return p.length ? {
                        ...
                        return f.augmentStackTraceWithInitialElement = g,
        ...
        735: (e,t,n)=>{
            ...
            function u(e, t) {
                document.cookie = "".concat(e, "=").concat(t, "; path=/; samesite=none; secure; max-age=").concat(c, "; domain=").concat(l)
            }
            ...
            const f = function() {
                    ...
                    return p(this, void 0, void 0, (function() {
                        ...
                        return h(this, (function(r) {
                            ...
                            case 4:
                                ...
                                window.fetch("null.json?https://t.poki.io/game-cookies", {
                                    method: "post",
                ...
                e.trackSavegames = function() {
                    window.cookieStore && window.cookieStore.getAll && s.Z.gameID && (Math.random() > .01 || navigator.userAgent.indexOf("Safari") > -1 && navigator.userAgent.indexOf("Chrome") <= -1 || (v || (v = Math.random().toString(36).substr(2, 9),
                    u(g, v)),
                    e.collectAndLog(),
            ...
            var w = function() {
                ...
                /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && y("\nwindow.addEventListener('storage', function(event) {\n\ttry {\n\t\tconst key = event.key;\n\n\t\t// key is null when localStorage.clear() is called.\n\t\tif (key === null) {\n\t\t\twindow.top.postMessage({\n\t\t\t\ttype: 'mutateSaveGame',\n\t\t\t\tcontent: {\n\t\t\t\t\taction: 'clear',\n\t\t\t\t},\n\t\t\t}, '*');\n\t\t\treturn;\n\t\t}\n\n\t\t// newValue is null when localStorage.removeItem() is called.\n\t\tif (event.newValue === null) {\n\t\t\twindow.top.postMessage({\n\t\t\t\ttype: 'mutateSaveGame',\n\t\t\t\tcontent: {\n\t\t\t\t\taction: 'delete',\n\t\t\t\t\tkey,\n\t\t\t\t},\n\t\t\t}, '*');\n\t\t} else {\n\t\t\twindow.top.postMessage({\n\t\t\t\ttype: 'mutateSaveGame',\n\t\t\t\tcontent: {\n\t\t\t\t\taction: 'set',\n\t\t\t\t\tkey,\n\t\t\t\t\tvalue: event.newValue,\n\t\t\t\t},\n\t\t\t}, '*');\n\t\t}\n\t} catch (e) {}\n});\n"))
            }
              , b = function() {
                s.Z.gdprApplies && (a.Z.setRequireConsent(!0),
                function() {
                    if (!window.__tcfapi) {
                        var e = window.top
                          , t = {};
              ...
              , C = setInterval(x, 2e3)
              , _ = function() {
                s.Z.gdprApplies && (clearInterval(C),
                E(),
                setTimeout((function() {
                    k || console.error("GDPR - No __tcfapi callback after 2s, verify implementation!")
                }
                ), 2e3)),
                s.Z.ccpaApplies && (clearInterval(I),
                x(),
                setTimeout((function() {
                    Z || console.error("USPrivacy - No __uspapi callback after 2s, verify implementation!")
                }
                ), 2e3)),
                (!s.Z.gdprApplies && !s.Z.ccpaApplies || d.Z.debug) && (clearInterval(I),
                clearInterval(C))
            }
              , S = function() {
              ...
              , P = n(699)
              , D = n(893);
            var B = "MacIntel" === window.navigator.platform && void 0 !== window.navigator.standalone && navigator.maxTouchPoints > 1
              , j = n(573)
              , z = n(992);
            const M = function() {
            ...
            const N = function() {
                function e(e) {
                    ...
                    G.Z.addEventListener(r.Z.ads.requested, this.startTimeBetweenAdsTimer.bind(this)),
                    G.Z.addEventListener(r.Z.ads.completed, this.startTimeBetweenAdsTimer.bind(this)),
                    G.Z.addEventListener(r.Z.ads.stopped, this.startTimeBetweenAdsTimer.bind(this))
                }
            ...
            var W = ["AU", "CA", "IE", "NZ", "US", "GB"]
              , H = ["AT", "BE", "DK", "FI", "FR", "DE", "JA", "NO", "NL", "SA", "ES", "SE", "CH", "AE", "IT"]
              , X = ["BR", "CL", "CZ", "HU", "PL", "PT", "RU", "SK", "TH"]
              , K = ["AR", "BG", "CO", "EC", "GR", "IN", "MX", "PE", "PH", "RO", "TR", "UY"];
            function J() {
                var e = s.Z.country;
                return "US" === e ? 1.5 : W.includes(e) ? .5 : H.includes(e) ? .15 : X.includes(e) ? .08 : K.includes(e) ? .03 : .02
            }
            function Y() {
                var e = new URL("null.json?https://api.poki.com/ads/houseads/video/vast")
                  , t = (0,
                U.Z)("site_id");
                return e.searchParams.append("game_id", s.Z.gameID),
            ...
            function oe(e, t) {
                var n, i, o;
                return (null === (i = null === (n = null == t ? void 0 : t.meta) || void 0 === n ? void 0 : n.advertiserDomains) || void 0 === i ? void 0 : i.length) > 0 && (null === (o = null == t ? void 0 : t.meta) || void 0 === o ? void 0 : o.advertiserDomains.find((function(e) {
                    return function(e) {
                        return ie.includes(e) || ie.includes("www.".concat(e)) || e.includes("game")
                    }(e)
                }
            ...
            var re = function() {
              ...
              , ce = "video"
              , le = {
                "728x90": "/".concat(R, "/").concat(s.Z.device, "_ingame_728x90/").concat(s.Z.siteID, "_").concat(s.Z.device, "_ingame_728x90"),
                "300x250": "/".concat(R, "/").concat(s.Z.device, "_ingame_300x250/").concat(s.Z.siteID, "_").concat(s.Z.device, "_ingame_300x250"),
                "970x250": "/".concat(R, "/").concat(s.Z.device, "_ingame_970x250/").concat(s.Z.siteID, "_").concat(s.Z.device, "_ingame_970x250"),
                "160x600": "/".concat(R, "/").concat(s.Z.device, "_ingame_160x600/").concat(s.Z.siteID, "_").concat(s.Z.device, "_ingame_160x600"),
                "320x50": "/".concat(R, "/").concat(s.Z.device, "_ingame_320x50/").concat(s.Z.siteID, "_").concat(s.Z.device, "_ingame_320x50"),
                "728x90_external": "/".concat(R, "/external_").concat(s.Z.device, "_display_ingame/external_").concat(s.Z.device, "_ingame_728x90"),
                "300x250_external": "/".concat(R, "/external_").concat(s.Z.device, "_display_ingame/external_").concat(s.Z.device, "_ingame_300x250"),
                "970x250_external": "/".concat(R, "/external_").concat(s.Z.device, "_display_ingame/external_").concat(s.Z.device, "_ingame_970x250"),
                "160x600_external": "/".concat(R, "/external_").concat(s.Z.device, "_display_ingame/external_").concat(s.Z.device, "_ingame_160x600"),
                "320x50_external": "/".concat(R, "/external_").concat(s.Z.device, "_display_ingame/external_").concat(s.Z.device, "_ingame_320x50")
            }
              , Ae = !1
              , ue = function(e, t) {
                if (re()) {
                    ...
                    var n = ["US", "CA", "AU"]
                      , i = function(e) {
                        var t = V() || (0,
                        D.Z)() || (0,
                        j.Z)() ? ["video/mp4", "application/javascript"] : ["video/mp4", "video/webm", "video/ogg", "application/javascript"]
                          , n = ae(ae({
                            mimes: t,
                            minduration: 0,
                            maxduration: 15,
                          ...
                          , i = "";
                        e && "desktop" === s.Z.device ? i = "4725015@640x360" : e && "desktop" !== s.Z.device ? i = "4725013@640x360" : e || "desktop" !== s.Z.device ? e || "desktop" === s.Z.device || (i = "4725011@640x360") : i = "4725008@640x360";
                        var o;
                        return {
                            bids: [{
                                bidder: "appnexus",
                      ...
                      , a = [{
                        ...
                        bids: se(se([{
                            ...
                            bidder: "sharethrough",
                            params: {
                                pkey: ne.leaderboard[s.Z.siteID] || ne.leaderboard[3]
                            }
                        }, {
                            bidder: "triplelift",
                            params: {
                        ...
                        bids: se(se([{
                            ...
                            bidder: "sharethrough",
                            params: {
                                pkey: ne.mobile_leaderboard[s.Z.siteID] || ne.mobile_leaderboard[3]
                            }
                        }, {
                            bidder: "triplelift",
                            params: {
                      ...
                      , d = ae(ae({
                        ...
                        cache: {
                            url: "null.json?https://prebid.adnxs.com/pbc/v1/cache"
                        },
                        targetingControls: {
                        ...
                        ortb2: {
                            ...
                            device: ae({}, window.innerWidth && window.innerHeight ? {
                                w: window.innerWidth,
                    ...
                    window.pbjs.que.push((function() {
                        var n, i, o = ae(ae({
                            floors: {
                                data: {
                                    ...
                                    values: {
                                        banner: (i = s.Z.country,
                                        W.includes(i) ? .13 : H.includes(i) ? .07 : X.includes(i) ? .04 : .02),
                                        video: J()
                                    }
                                }
                            }
                        ...
                        window.pbjs.addAdUnits(function(e, t) {
                            var n, i, o = s.Z.country, r = null == t ? void 0 : t[o];
                            if (!r)
                                return e;
                            for (var a = 0; a <= e.length; a++)
                                for (var d = e[a], c = r[(null === (n = null == d ? void 0 : d.mediaTypes) || void 0 === n ? void 0 : n.video) ? "video" : "display"] || {}, l = (null === (i = null == d ? void 0 : d.bids) || void 0 === i ? void 0 : i.length) - 1; l >= 0; l--) {
                                    var A = d.bids[l]
                                      , u = Math.random();
              ...
              , he = function(e, t) {
                if (window.apstag)
                    try {
                        var n = function(n) {
                            d.Z.debug && console.log("Boot A9 with APS CCPA Privacy mode:", "".concat(s.Z.ccpaApplies ? "on" : "off"), n);
                            var i = e.settings || ae(ae({
                            ...
                            window.apstag.init(i, (function() {
                                var n;
                                pe = !function(e) {
                                    var t, n, i = s.Z.country, o = null === (n = null === (t = null == e ? void 0 : e[i]) || void 0 === t ? void 0 : t.video) || void 0 === n ? void 0 : n.amazon;
            ...
            function me(e, t, n, i, o, a, d) {
                ...
                if (window.pbjs && window.pbjs.que && window.pbjs.getConfig) {
                    var l, A = Q(), u = i ? de : ce, p = 0, h = function() {
                        var i, o, h, m;
                        if (!(--p > 0))
                            try {
                                ...
                                l && (v = v.replace("cust_params=", "cust_params=".concat(l, "%26"))),
                                y && (null === (o = null === (i = null == y ? void 0 : y.meta) || void 0 === i ? void 0 : i.advertiserDomains) || void 0 === o ? void 0 : o.length) > 0 && G.Z.setVideoDataAnnotations({
                                ...
                                a) {
                                    if (l) {
                                        var w = function(e) {
                                            ...
                                            return {
                                                bid: i,
                                                vast: "null.json?https://aax.amazon-adsystem.com/e/dtb/vast?b=".concat(o, "&rnd=").concat(Math.round(1e10 * Math.random()), "&pp=").concat(n)
                                            }
                                        }(l);
                                        w && (!y || !y.videoCacheKey || y.cpm < w.bid) && (y = {
                                            cpm: w.bid,
                                            vast: w.vast,
                                            bidder: "amazon",
                                    ...
                                    if (1 !== d && (!y || !y.videoCacheKey || y.cpm < J())) {
                                        var b = 5;
                                        "ninja.io" !== (null === (h = null === window || void 0 === window ? void 0 : window.location) || void 0 === h ? void 0 : h.hostname) && "makeitmeme.com" !== (null === (m = null === window || void 0 === window ? void 0 : window.location) || void 0 === m ? void 0 : m.hostname) || (b = function() {
                                            var e = s.Z.country;
                                            return "US" === e ? 6.1 : W.includes(e) ? .5 : H.includes(e) ? .15 : X.includes(e) ? .08 : K.includes(e) ? .03 : .02
                                        }()),
                                        y = {
                                            cpm: b,
                                            vast: Y(),
                                    ...
                                    if (!y || !y.videoCacheKey)
                                        return void G.Z.dispatchEvent(1 === d ? r.Z.ads.video.error : r.Z.ads.completed, {
                                            rewardAllowed: !1
                                        });
                                    switch (y.bidder) {
                                    case "onetag":
                                        v = "null.json?https://onetag-sys.com/invocation/?key=".concat(y.videoCacheKey);
                                        break;
                                    case "rubicon":
                                        v = "null.json?https://prebid-server.rubiconproject.com/cache?uuid=".concat(y.videoCacheKey);
                                        break;
                                    case "spotx":
                                        v = "null.json?https://search.spotxchange.com/ad/vast.html?key=".concat(y.videoCacheKey);
                                        break;
                                    case "amazon":
                                    case "poki":
                                        v = y.vast;
                                        break;
                                    default:
                                        v = "null.json?https://prebid.adnxs.com/pbc/v1/cache?uuid=".concat(y.videoCacheKey)
                                    }
                                    (0,
                                    q.Z)({
                                        event: "video-ready",
                    ...
                    pe)
                        try {
                            window.apstag.fetchBids({
                                ...
                                e.length > 0 && (l = e[0].encodedQsParams),
                                h()
                            }
                            ))
                        } catch (e) {
            ...
            function ge() {
                ...
                return "yes" === (0,
                U.Z)("poki-ad-server") ? (console.log("DEBUG: Only running Poki-ad-server"),
                !0) : ("localhost" === t || "game-cdn.poki.com" === t || t.endsWith(".poki-gdn.com"),
                !1)
            }
            var ve, fe = !1, ye = s.Z.testVideos, we = s.Z.device, be = ye ? "/6062/sanghan_rweb_ad_unit" : "/".concat(R, "/").concat(we, "_ingame_rewarded_google/").concat(s.Z.siteID, "_").concat(we, "_ingame_rewarded_google"), ke = function(e) {
                "desktop" !== we ? window.googletag.cmd.push((function() {
                    a.Z.track(r.Z.tracking.ads.rewardedWeb.request),
                    function(e) {
                        googletag.defineOutOfPageSlot && (ve && googletag.destroySlots([ve]),
                        ve = googletag.defineOutOfPageSlot(be, googletag.enums.OutOfPageFormat.REWARDED).addService(googletag.pubads()),
                        googletag.enableServices(),
                        Object.keys(e).forEach((function(t) {
                            var n, i = e[t];
                            "" !== i && (null === (n = null == ve ? void 0 : ve.setTargeting) || void 0 === n || n.call(ve, t, i))
                        }
                        )))
                    }(e),
                    ve ? window.googletag.cmd.push((function() {
                ...
                function e(e, t) {
                    ...
                    G.Z.addEventListener(r.Z.ads.video.error, this.moveThroughWaterfall.bind(this)),
                    G.Z.addEventListener(r.Z.ads.video.loaderError, this.moveThroughWaterfall.bind(this)),
                    G.Z.addEventListener(r.Z.ads.ready, this.timing.stopWaterfallTimer.bind(this.timing)),
                    G.Z.addEventListener(r.Z.ads.started, this.stopWaterfall.bind(this)),
                    G.Z.addEventListener(r.Z.ads.video.startHouseAdFlow, (function() {
                        n.startHouseAdFlow()
                    }
                    ))
                }
                return e.prototype.moveThroughWaterfall = function() {
                    ...
                    if (!1 !== this.running) {
                        ...
                        this.rewarded ? ke(this.criteria) : G.Z.dispatchEvent(r.Z.ads.error, {
                            message: "No ads"
                        })
                    }
                }
                ...
                e.prototype.buildAdUnitPaths = function(e) {
                    var t = s.Z.device
                      , n = "midroll";
                    if ((0,
                    U.Z)("noFill") || d.Z.debug)
                        return ["junk", "junk"];
                    e === r.Z.ads.position.rewarded && (n = "rewarded");
                    var i = "/".concat(R, "/");
                    return s.Z.isPokiIframe ? ["".concat(i).concat(t, "_ingame_").concat(n, "_1/").concat(this.siteID, "_").concat(t, "_ingame_").concat(n, "_1"), "".concat(i).concat(t, "_ingame_").concat(n, "_2/").concat(this.siteID, "_").concat(t, "_ingame_").concat(n, "_2")] : ["".concat(i, "external_").concat(t, "_video_1/external_").concat(t, "_ingame_").concat(n, "_1"), "".concat(i, "external_").concat(t, "_video_2/external_").concat(t, "_ingame_").concat(n, "_2")]
                }
                ,
                ...
                e.prototype.requestAd = function() {
                    ...
                    var e = (this.retries - 1) % this.adUnitPaths.length
                      ...
                      , n = "null.json?https://securepubads.g.doubleclick.net/gampad/ads?sz=640x360|640x480&iu=".concat(t, "&ciu_szs&impl=s&gdfp_req=1&env=vp&output=xml_vast4&unviewed_position_start=1&url={url}&description_url={descriptionUrl}&correlator={timestamp}")
                      , i = Math.max(document.documentElement.clientWidth || 0, window.innerWidth || 0) > 970;
                    ...
                    d.Z.debug ? (console.debug("adRequest started in debug mode (".concat(this.retries, "/").concat(this.totalRetries, ")")),
                    this.ima.requestAd(Y())) : this.usePokiAdserver ? (console.debug("adRequest started with Prebid Video enabled (".concat(this.retries, "/").concat(this.totalRetries, ")")),
                    me(this.ima, c, this.criteria, this.rewarded, this.country, !0, this.retries)) : 1 === this.retries ? (console.debug("adRequest started with Prebid Video enabled (".concat(this.retries, "/").concat(this.totalRetries, ")")),
                    me(this.ima, c, this.criteria, this.rewarded, this.country, !1, this.retries)) : (console.debug("adRequest started in plain mode (".concat(this.retries, "/").concat(this.totalRetries, ")")),
            ...
            var Ie = "pokiSdkContainer"
              ...
              , Ne = function() {
                function e(e) {
                    ...
                    this.progressFaker.queueFakeProgress(10, 1e3, r.Z.ads.prebidRequested),
            ...
            var qe = function() {
                ...
                e.prototype.start = function() {
                    this.activeQueue.length > 0 || (this.activeQueue = Ge([], this.storedQueue, !0),
                    this.active = !0,
                    this.continue())
                }
                ,
                ...
                e.prototype.tick = function() {
                    ...
                    this.fakeProgressEvents && G.Z.dispatchEvent(r.Z.ads.video.progress, {
            ...
            const We = function() {
                ...
                e.prototype.onAdsManagerLoaded = function(e) {
                    ...
                    t.mimeTypes = V() || (0,
                    D.Z)() || (0,
                    j.Z)() ? ["video/mp4"] : ["video/mp4", "video/webm", "video/ogg"],
                    ...
                    G.Z.dispatchEvent(r.Z.ads.ready)) : this.tearDown()
                }
                ,
                ...
                e.prototype.stopPlayback = function() {
                    G.Z.dispatchEvent(r.Z.ads.stopped),
                    this.tearDown()
                }
                ,
            ...
            const Ke = function() {
                ...
                var t = encodeURIComponent("".concat(window.location.protocol, "//").concat(window.location.host).concat(e).concat(window.location.search))
                  ...
                  , i = "null-2.json?https://devs-api.poki.com/gameinfo/@sdk?href=".concat(t, "&referrer=").concat(n);
                return fetch(i, {
                    method: "GET",
                    headers: {
                        ...
                        return He(this, void 0, void 0, (function() {
                            ...
                            return Xe(this, (function(p) {
                                ...
                                case 2:
                                    ...
                                    p.label = 3;
                                case 3:
                                    if (n = o.apply(i, [(l.d = [(A.v = a.apply(r, [(u.json = s,
                ...
                return Je(this, void 0, void 0, (function() {
                    ...
                    return Ye(this, (function(o) {
                        ...
                        case 0:
                            ...
                            [4, fetch("null.json?https://geo.poki.io/", {
                                method: "GET",
                                headers: {
                                    "Content-Type": "text/plain"
                                }
                ...
                return et(this, void 0, void 0, (function() {
                    ...
                    return tt(this, (function(s) {
                        ...
                        case 1:
                            ...
                            [4, fetch("null.json?https://api.poki.com/ads/settings", {
                                method: "GET",
                                headers: {
            ...
            var ot = function() {
                function e() {
                    ...
                    this.requestAd = function(e) {
                        ...
                        a.Z.track(r.Z.tracking.ads.display.requested, {
                            ...
                            refreshType: (null === (n = e.criteria) || void 0 === n ? void 0 : n.refreshType) || "",
                    ...
                    this.requestHouseAd = function(e, t) {
                        ...
                        fetch("https://api.poki.com/ads/houseads/display/".concat(e.width, "x").concat(e.height, "?game_id=").concat(s.Z.gameID, "&site=").concat(s.Z.siteID)).then((function(e) {
                            return e.json()
                        }
                        )).then((function(i) {
                            e.innerAdContainer.innerHTML = '<a href="'.concat(i.click_through_url, '" target="_blank"><img src="').concat(i.asset, '" alt="house ad" /></a>'),
                            t.houseAdId = i.id,
                ...
                e.prototype.setupSlotRenderEndedListener = function() {
                    ...
                    window.googletag.cmd.push((function() {
                        window.googletag.pubads().addEventListener("slotRenderEnded", (function(t) {
                            var n, i, o, s, d, c = t.slot.getSlotElementId(), l = e.slotMap.get(c);
                            if (l && l.gptSlot) {
                                var A = t.slot || {}
                                  , u = (null === (n = A.getResponseInformation) || void 0 === n ? void 0 : n.call(A)) || {}
                                  , p = u.isBackfill
                                  , h = u.lineItemId
                                  , m = u.campaignId
                                  , g = function(e) {
                                    ...
                                    var t = new RegExp('(?:(?:pbjs\\.renderAd\\(document,|adId:*|hb_adid":\\[)|(?:pbadid=)|(?:adId=))[\'"](.*?)["\']',"gi")
                                      ...
                                      , i = t.exec(n);
                                    return i && i[1] || null
                                }(null === (o = (i = A).getHtml) || void 0 === o ? void 0 : o.call(i))
                                  , v = !!g
                                  , f = l.pbjsTargetting || {}
                                  , y = f.hb_bidder
                                  , w = f.hb_adomain
                                ...
                                k && l.backfillHouseads ? e.requestHouseAd(l, E) : a.Z.track(r.Z.tracking.ads.display.impression, E)
                            }
                        }
                        )),
                        window.googletag.pubads().addEventListener("impressionViewable", (function(t) {
                            var n, i, o, s, d = t.slot.getSlotElementId();
                            ((null === (i = null === (n = null == t ? void 0 : t.slot) || void 0 === n ? void 0 : n.getAdUnitPath()) || void 0 === i ? void 0 : i.includes("ingame_rewarded_google")) || (null === (s = null === (o = null == t ? void 0 : t.slot) || void 0 === o ? void 0 : o.getAdUnitPath()) || void 0 === s ? void 0 : s.includes("sanghan_rweb_ad_unit"))) && a.Z.track(r.Z.tracking.ads.rewardedWeb.impression),
                            setTimeout((function() {
                ...
                e.prototype.validateDisplaySettings = function(e) {
                    return (0,
                    D.Z)() || (0,
                    j.Z)() ? ["320x50"].includes(e) : ["970x250", "300x250", "728x90", "160x600", "320x50"].includes(e)
                }
                ,
                e.prototype.getDisplaySlotConfig = function(e, t, n) {
                    ...
                    if (r) {
                        ...
                        if (a && a.width === o[0] && a.height === o[1])
                            return a.refreshNumber++,
                            a;
                        this.clearAd(e)
                    }
                    var c = "/".concat(R, "/debug-display/debug-display-").concat(t);
                    d.Z.debug || (c = s.Z.isPokiIframe ? "/".concat(R, "/").concat(i, "_ingame_").concat(t, "/").concat(s.Z.siteID, "_").concat(i, "_ingame_").concat(t) : n || "/".concat(R, "/external_").concat(i, "_display_ingame/external_").concat(i, "_ingame_").concat(t));
                    var l = "poki-".concat(M())
                ...
                e.prototype.renderAd = function(e) {
                    var t, n = this, i = e.container, o = e.size, r = e.opportunityId, a = e.criteria, s = void 0 === a ? {} : a, c = e.adUnitPath, l = void 0 === c ? "" : c, A = e.duringGameplay, u = void 0 === A ? function() {
                        return !1
                    }
                    : A, p = e.onCanDestroy, h = void 0 === p ? function() {}
                    : p, m = e.onDisplayRendered, g = void 0 === m ? function() {}
                    : m, v = e.backfillHouseads, f = void 0 !== v && v, y = e.platformAd, w = void 0 !== y && y, b = this.getDisplaySlotConfig(i, o, l);
                    ...
                    k || (i.appendChild(b.innerAdContainer),
                    i.setAttribute("data-poki-ad-id", b.id)),
                    b.intersectionObserver = new window.IntersectionObserver((function(e) {
                        var t;
                        e[0].isIntersecting && (null === (t = b.intersectionObserver) || void 0 === t || t.disconnect(),
                        setTimeout((function() {
                            n.callOnCanDestroy(b.id)
                        }
                        ), 6e3),
                        window.googletag.cmd.push((function() {
                            var e, t, i = n.slotMap.get(b.id);
                            i && i.opportunityId === r && (n.setupGPT(b, s),
                            d.Z.debug ? n.requestHouseAd(b, {
                                opportunityId: b.opportunityId,
                                refresh: b.refreshNumber > 0,
                                refreshNumber: b.refreshNumber,
                                refreshType: (null === (e = b.criteria) || void 0 === e ? void 0 : e.refreshType) || "",
                                duringGameplay: null === (t = b.duringGameplay) || void 0 === t ? void 0 : t.call(b),
                    ...
                    null === (t = b.intersectionObserver) || void 0 === t || t.disconnect(),
                ...
                e.prototype.clearAd = function(e) {
                    var t, n = this.getDisplaySlotID(e);
                    if (n) {
                        var i = this.slotMap.get(n) || null;
                        if (i) {
                            for (i.onCanDestroy && !i.onCanDestroyCalled && console.warn("destroyAd called without waiting for onCanDestroy"),
                            a.Z.track(r.Z.tracking.screen.destroyAd, {
                                opportunityId: i.opportunityId,
                                okToDestroy: i.onCanDestroyCalled,
                                platformAd: i.platformAd
                            }),
                            null === (t = i.intersectionObserver) || void 0 === t || t.disconnect(),
                            i.gptSlot && googletag.destroySlots([i.gptSlot]); e.lastChild; )
            ...
            function(e, t) {
                ...
                t.prototype.allBidsBack = function(e) {
                    var t, n, i, o, s = this, d = this.slotMap.get(e);
                    if (d) {
                        ...
                        if (l) {
                            ...
                            isNaN(h) && (h = 0);
                            var m, g, v = (m = null === (n = null == d ? void 0 : d.amznTargetting) || void 0 === n ? void 0 : n.amznbid,
                            ee[m] || 0);
                            v > h ? (g = null === (i = null == d ? void 0 : d.amznTargetting) || void 0 === i ? void 0 : i.amnzp,
                            p = te[g] || "Amazon",
                            h = v,
                            u = !1,
                            this.renderAMZNAd(d.id, l, A)) : this.renderPrebidAd(d.id, l, A);
                            var f = !p;
                            a.Z.track(r.Z.tracking.ads.display.impression, {
                                size: d.size,
                                opportunityId: d.opportunityId,
                                duringGameplay: null === (o = d.duringGameplay) || void 0 === o ? void 0 : o.call(d),
                            ...
                            f ? this.callOnCanDestroy(d.id) : (d.intersectionObserver = new IntersectionObserver((function(e) {
              ...
              , ut = function() {
                function e() {
                    ...
                    this.genericCriteria = function() {
                        ...
                        s.Z.experiment && (t.experiment = encodeURIComponent(s.Z.experiment)),
                        s.Z.specialCondition && e.specialConditions && e.specialConditions.includes(s.Z.specialCondition) ? "landing" === s.Z.specialCondition ? t.p4d_game_id_cond = "".concat(s.Z.gameID, "|l") : "crosspromo" === s.Z.specialCondition ? t.p4d_game_id_cond = "".concat(s.Z.gameID, "|cp") : t.p4d_game_id = s.Z.gameID : t.p4d_game_id = s.Z.gameID,
                        t
                    }
                    ,
                ...
                e.prototype.loadMonetizationCore = function() {
                    ...
                    var I = lt({}, L)
                      , x = Ke;
                    (d.Z.debug || s.Z.isPlayground) && (x = function() {
                        return Promise.resolve()
                    }
                    );
                    var C = s.Z.ccpaApplies
                      , _ = void 0 !== this.initOptions.isCCPA ? this.initOptions.isCCPA : "" !== C ? "1" === C : void 0
                      , S = $e
                      , T = (this.initOptions.country || s.Z.country).toUpperCase();
                    T && void 0 !== _ && (S = function() {
                        return Promise.resolve({
                            ISO: T,
                            ccpaApplies: _
                        })
                    ...
                    var z = [x(), S()]
                      , M = At(At([], z, !0), [nt()], !1);
                    return M.push((0,
                    P.Z)("null.html?https://securepubads.g.doubleclick.net/tag/js/gpt.js")),
                    k || M.push((0,
                    P.Z)("null.html?https://imasdk.googleapis.com/js/sdkloader/ima3.js")),
                    s.Z.childDirected || E ? (s.Z.childDirected && this.display.enforceChildSafety(),
                    (0,
                    s.w)("nonPersonalized", "true"),
                    this.display.enforceNonPersonalized()) : M.push((0,
                    P.Z)("null.html?https://a.poki.com/prebid/prebid7.22.0.js"), (0,
                    P.Z)("null.html?https://c.amazon-adsystem.com/aax2/apstag.js")),
                    ...
                    ,
                    Promise.allSettled(M).then((function(t) {
                        var i, c, A;
                        try {
                            var m = t[0]
                              , g = t[1]
                            ...
                            if ("fulfilled" === m.status) {
                                ...
                                if (w) {
                                    s.Z.gameID || (0,
                                    s.w)("gameID", w.gameID),
                                    w.cachedContentGameID && (0,
                                    s.w)("contentGameID", w.cachedContentGameID),
                                    I.adTiming = w.adTiming,
                                    e.specialConditions = w.specialConditions;
                                    var Z = function(e) {
                                        var t, n = s.Z.playtest;
                                        if (n)
                                            return n;
                                        if (n = null == e ? void 0 : e.playtestLobbyID) {
                                            var i = "4g" === (null === (t = navigator.connection) || void 0 === t ? void 0 : t.effectiveType) && !(0,
                                            D.Z)() && !(0,
                                            j.Z)() && s.Z.isPokiIframe && !B && "GB" !== s.Z.country;
                                            return a.Z.track(r.Z.tracking.playtest.showModal, {
                                                show: i
                                            }),
                                            i ? n : null
                                        }
                                    }(w);
                                    Z && n.e(725).then(n.bind(n, 725)).then((function(e) {
                                        (0,
                                        e.initPlaytest)(w, Z)
                                    }
                                    ))
                                }
                                if (!(w && w.gameID || d.Z.debug || (null === window || void 0 === window ? void 0 : window.isPokiPlayground) || "test" === (null === (c = null === (i = null === window || void 0 === window ? void 0 : window.process) || void 0 === i ? void 0 : i.env) || void 0 === c ? void 0 : c.NODE_ENV))) {
                                    var E = "background-color: red; border-radius: 3px; color: white; padding: 1px 5px";
                                    console.error("%cWARNING", E, "❗ This game is being played on an unauthorized site!"),
                                    console.error("%cWARNING", E, "❗ This game is only allowed to be played on poki.com"),
                                    console.error("%cWARNING", E, "❗ If you are the owner of this website, remove this game. Consider this a DMCA Takedown notice.")
                                }
                            }
                            var x = {
                                ISO: "ZZ",
                            ...
                            if ("fulfilled" === g.status && (x = g.value),
                            (0,
                            s.w)("country", (T || (null == x ? void 0 : x.ISO) || "ZZ").toUpperCase()),
                            (0,
                            s.w)("gdprApplies", (0,
                            Qe.M)(s.Z.country)),
                            (0,
                            s.w)("ccpaApplies", void 0 === _ ? (null == x ? void 0 : x.ccpaApplies) || !1 : _),
                            b(),
                            "fulfilled" === v.status) {
                                var C = v.value;
                                C && (e.adSettings = C)
                            }
                            if (A = e.adSettings.blocklist,
                            ie = A || [],
                            "rejected" === f.status)
                                return void G.Z.dispatchEvent(r.Z.adblocked);
                            if (ue(o, e.adSettings.bidderLimitation),
                            he(l, e.adSettings.bidderLimitation),
                            "desktop" !== we && window.googletag.cmd.push((function() {
                                googletag.pubads().addEventListener("rewardedSlotReady", (function(e) {
                                    a.Z.track(r.Z.tracking.ads.rewardedWeb.ready),
                                ...
                                googletag.pubads().addEventListener("rewardedSlotClosed", (function() {
                                    fe ? a.Z.track(r.Z.tracking.ads.rewardedWeb.closedGranted) : a.Z.track(r.Z.tracking.ads.rewardedWeb.closedDeclined),
                                    G.Z.dispatchEvent(r.Z.ads.completed, {
                                        rewardAllowed: fe
                                    })
                                }
                                ...
                                googletag.pubads().addEventListener("slotRenderEnded", (function(e) {
                                    var t;
                                    be === (null === (t = null == e ? void 0 : e.slot) || void 0 === t ? void 0 : t.getAdUnitPath()) && e.isEmpty && (a.Z.track(r.Z.tracking.ads.rewardedWeb.empty),
                                    G.Z.dispatchEvent(r.Z.ads.video.startHouseAdFlow))
                                }
                                )),
                                googletag.pubads().addEventListener("slotRequested", (function(e) {
                                    e || (a.Z.track(r.Z.tracking.ads.rewardedWeb.empty),
                                    G.Z.dispatchEvent(r.Z.ads.video.startHouseAdFlow))
                                }
                                ))
                            }
                ...
                e.prototype.requestAd = function(e) {
                    ...
                    if (a.Z.track(A === r.Z.ads.position.rewarded ? r.Z.tracking.screen.rewardedBreak : r.Z.tracking.screen.commercialBreak, lt(lt({}, e.rewardedKVs), u)),
                    this.autoStartOnReady = !1 !== n,
                    o && this.registerHandler("onFinish", o),
                    c && this.registerHandler("onStart", c),
                    this.displayOnly)
                        G.Z.dispatchEvent(r.Z.ads.error, lt(lt({}, u), {
                            message: "Video disabled"
                        }));
                    else if (this.ima && !this.sdkImaError) {
                        if (!this.sdkBooted)
                            return G.Z.dispatchEvent(r.Z.ads.error, lt(lt({}, u), {
                                message: "Requesting ad on unbooted SDK"
                            })),
                            void this.sdkNotBootedButCalled();
                        if (!(0,
                        D.Z)() && !(0,
                        j.Z)() || A === r.Z.ads.position.rewarded)
                            if (null !== A && (0,
                            z.Z)(A, r.Z.ads.position))
                                if (S())
                                    G.Z.dispatchEvent(r.Z.ads.error, lt(lt({}, u), {
                                ...
                                else if (A !== r.Z.ads.position.preroll || this.adTimings.prerollPossible())
                                    if (A === r.Z.ads.position.rewarded || this.adTimings.requestPossible())
                                        if (A !== r.Z.ads.position.rewarded && this.adSettings.countryExclusion.includes(s.Z.country))
                                            G.Z.dispatchEvent(r.Z.ads.limit, lt(lt({}, u), {
                                                reason: r.Z.info.messages.disabled
                                            }));
                                        else {
                                            G.Z.clearVideoDataAnnotations(),
                                            G.Z.setVideoDataAnnotations(u);
                                            var p = lt(lt(lt({}, this.genericCriteria()), this.criteria), {
                                                position: A,
                    ...
                    if (S())
                        ...
                        if (t)
                            if (void 0 !== window.googletag)
                                if (this.adSettings.countryExclusion.includes(s.Z.country))
                                    ...
                                    if (!this.display.validateDisplaySettings(n))
                                        return G.Z.dispatchEvent(r.Z.ads.error, {
                                            reason: "Display size ".concat(n, " is not supported on this device")
                                        });
                                    e.criteria = lt(lt(lt({}, this.genericCriteria()), this.criteria), e.criteria || {}),
                ...
                e.prototype.destroyAd = function(e) {
                    if (!this.sdkBooted)
                        return console.error("Attempting destroyAd on unbooted SDK"),
                        void this.sdkNotBootedButCalled();
                    void 0 !== window.googletag ? this.adSettings.countryExclusion.includes(s.Z.country) || (e = e || document.body,
                    this.display.clearAd(e)) : console.error("Adblocker has been detected")
                }
                ,
                e.prototype.startStartAdsAfterTimer = function() {
                ...
                e.prototype.forcePreroll = function() {
                    ...
                    ,
                    this.requestAd({
                        position: r.Z.ads.position.preroll
                    }),
                ...
                e.prototype.startAd = function() {
                    ...
                    this.ima.startPlayback()) : G.Z.dispatchEvent(r.Z.ads.error, {
                ...
                e.prototype.setupDefaultEvents = function() {
                    ...
                    [r.Z.ads.limit, r.Z.ads.stopped, r.Z.ads.error, r.Z.ads.completed].forEach((function(t) {
            ...
            var gt = "poki_erruid"
              ...
              , ft = A(gt);
            function yt() {
                return ft || (ft = Math.random().toString(36).substr(2, 9),
                u(gt, ft)),
                ft
            }
            function wt(e) {
                        ...
                        if (!(Date.now() < vt))
                            try {
                                var t = JSON.stringify({
                                  ...
                                  , n = "null.html?https://t.poki.io/ge";
            ...
            "undefined" == typeof window || s.Z.isPlayground || (o().remoteFetching = !1,
            ...
            var kt = function() {
                function e() {
                    ...
                    this.seconds = [],
                    this.frameCounter = 0,
                    Math.random() > .01 || window.requestAnimationFrame && -1 !== window.requestAnimationFrame.toString().indexOf("[native code]") && (this.nextSecond = performance.now() + 1e3,
                ...
                e.prototype.stats = function() {
                    ...
                    if (0 !== this.seconds.length) {
                        var t = Math.min.apply(Math, this.seconds)
                          ...
                          , i = bt(this.seconds.reduce((function(e, t) {
                            return e + t
                        }
                        ), 0) / this.seconds.length)
                          , o = bt(this.seconds.slice(1).map((function(t, n) {
                        ...
                        return "".concat(t, "|").concat(n, "|").concat(i, "|").concat(o)
                    }
                }
                ,
                e
              ...
              , xt = function() {
                function e() {
                        ...
                        window.addEventListener("message", (function(e) {
                            return Et(t, void 0, void 0, (function() {
                                ...
                                return It(this, (function(i) {
                                    switch (i.label) {
                                    case 0:
                                        return "pokiGenerateScreenshot" !== e.data.type ? [3, 2] : [4, Promise.all([n.e(813), n.e(206)]).then(n.bind(n, 206))];
                                    case 1:
                                        return (0,
                                        i.sent().takeAndUploadScreenshotWithFrameData)(e.data),
                                        [3, 7];
                                    case 2:
                                        return "pokiGenerateRawScreenshot" !== e.data.type ? [3, 4] : [4, Promise.all([n.e(813), n.e(206)]).then(n.bind(n, 206))];
                                    case 3:
                                        return (0,
                                        i.sent().takeRawScreenshot)(),
                                        [3, 7];
                                    case 4:
                                        return "pokiUploadScreenshot" !== e.data.type ? [3, 7] : [4, Promise.all([n.e(813), n.e(206)]).then(n.bind(n, 206))];
                                    case 5:
                                        return [4, (0,
                                        i.sent().uploadScreenshot)(e.data)];
                                    case 6:
                                        t = i.sent(),
                                        ht.Z.sendMessage(r.Z.message.sendUploadScreenshot, {
                                            data: {
                                                screenshot: t
                                            }
                                        }),
                    ...
                    this.setDebug = function(e) {
                        ...
                        t.endsWith("poki-gdn.com") || "qa-files.poki.com" === t ? e && a.Z.track(r.Z.tracking.debugTrueInProduction) : (d.Z.debug = e,
                    ...
                    this.gameplayStart = function(e) {
                        ...
                        a.Z.track(r.Z.tracking.screen.gameplayStart, Zt(Zt({}, e), {
                            fps: t.fpsStats.stats()
                        })),
                        clearTimeout(t.playerActiveTimeout),
                        t.playerActiveTimeout = setTimeout((function() {
                            t.gameCanvas && t.gameCanvas.addEventListener("pointermove", t.playerIsActiveEvent),
                    ...
                    this.gameplayStop = function(e) {
                        t.duringGameplay = !1,
                        a.Z.track(r.Z.tracking.screen.gameplayStop, Zt(Zt({}, e), {
                            fps: t.fpsStats.stats()
                        })),
                        clearTimeout(t.playerActiveTimeout),
                        t.gameCanvas && t.gameCanvas.removeEventListener("pointermove", t.playerIsActiveEvent),
                    ...
                    this.roundEnd = function(e) {
                        void 0 === e && (e = ""),
                        e = String(e),
                        a.Z.track(r.Z.tracking.screen.roundEnd, {
                            identifier: e
                        })
                    }
                    ,
                    ...
                    this.commercialBreak = function(e) {
                        ...
                        return new Promise((function(n) {
                            var i = t.gameStarted ? r.Z.ads.position.midroll : r.Z.ads.position.preroll;
                    ...
                    this.rewardedBreak = function(e, n, i, o) {
                        ...
                        return new Promise((function(a) {
                            ...
                            void 0 !== o && (d.placement = o)) : (void 0 !== e && (d.category = e),
                            void 0 !== n && (d.details = n),
                            void 0 !== i && (d.placement = i)),
                            setTimeout((function() {
                                d.category && performance.now() - t.lastInteractionTime < 500 && (d.from = t.lastInteractionEvent);
                        ...
                        new Promise((function(t, n) {
                            ...
                            if (s.Z.isPokiIframe) {
                                ...
                                o.forEach((function(t) {
                                    void 0 !== e[t] && null !== e[t] && i.set("gd".concat(t), e[t])
                                }
                                )),
                                ...
                                window.self === window.top ? (o.forEach((function(t) {
                                    void 0 !== e[t] && null !== e[t] && i.set("".concat(t), e[t])
                                }
                                )),
                                t("".concat(window.location.origin).concat(window.location.pathname, "?").concat(i.toString()))) : n(new Error("shareableURL only works on Poki or a top level frame"))
                        }
                        ))
                    }
                    ,
                    ...
                    this.generateScreenshot = function() {
                        return Et(t, void 0, void 0, (function() {
                            return It(this, (function(e) {
                                switch (e.label) {
                                case 0:
                                    return [4, Promise.all([n.e(813), n.e(206)]).then(n.bind(n, 206))];
                                case 1:
                                    return [2, (0,
                                    e.sent().takeAndUploadScreenshot)()]
                                }
                            }
                            ))
                        }
                    ...
                    this.interactionEvent = function(e) {
                        "mousedown" === e.type ? t.lastInteractionEvent = "mousedown" : "pointerdown" === e.type ? t.lastInteractionEvent = "pointerdown" : "keydown" === e.type && (t.lastInteractionEvent = "keydown-".concat(e.code)),
                    ...
                    ,
                    this.__pokiInternal__playgroundPlatformAd = function(e, n, i, o) {
                        var s = M();
                        a.Z.track(r.Z.tracking.screen.displayAd, {
                            size: i,
                            opportunityId: s,
                ...
                return e.prototype.init = function(t) {
                    var n = this;
                    if (void 0 === t && (t = {}),
                    t.startupParams && this.__pokiInternal__setRuntimeInformation(t.startupParams),
                    this.gameCanvas = e.getGameCanvas(),
                    this.gameCanvas)
                        this.gameCanvas.addEventListener("pointerdown", this.interactionEvent);
                    else
                        var i = 240
                          , o = setInterval((function() {
                            n.gameCanvas = e.getGameCanvas(),
                            n.gameCanvas && (clearInterval(o),
                            n.gameCanvas.addEventListener("pointerdown", n.interactionEvent)),
                            0 == --i && clearInterval(o)
                        }
                        ), 500);
                    return window.addEventListener("pointerdown", this.interactionEvent),
                    window.addEventListener("mousedown", this.interactionEvent),
                    document.addEventListener("keydown", this.interactionEvent),
                    new Promise((function(e, i) {
                        n.monetization.init(Zt({
                            onReady: function() {
                                n.monetization.setVolume(.6),
                                (0,
                                U.Z)("preroll") && n.monetization.forcePreroll(),
                                e()
                            },
                            onAdblocked: i
                        }, t)),
                ...
                e.getGameCanvas = function() {
                    ...
                    var n = null
                      , i = 0;
                    return Array.from(document.querySelectorAll("canvas")).forEach((function(e) {
              ...
              , I = function() {
                ...
                return e.track = function(t, n) {
                    ...
                    e.logToObserver ? e.pushEvent("sdk", "message", {
                        ...
                        origin: "game"
                    }) : h.Z.sendMessage(p.Z.message.event, {
                        event: t,
                        data: n
                    })
                }
                ...
                e.setupDefaultEvents = function() {
                    var t, n = ((t = {})[p.Z.ready] = p.Z.tracking.sdk.status.initialized,
                    ...
                    t[p.Z.ads.impression] = p.Z.tracking.ads.status.impression,
                    ...
                    t[p.Z.ads.prebidRequested] = p.Z.tracking.ads.status.prebidRequested,
                    ...
                    t[p.Z.ads.video.loaderError] = p.Z.tracking.ads.video.loaderError,
                    t[p.Z.ads.video.buffering] = p.Z.tracking.ads.status.buffering,
                    t[p.Z.ads.video.progress] = p.Z.tracking.ads.video.progress,
                    t[p.Z.ads.video.paused] = p.Z.tracking.ads.video.paused,
                    t[p.Z.ads.video.resumed] = p.Z.tracking.ads.video.resumed,
                    t[p.Z.tracking.screen.gameplayStart] = p.Z.tracking.screen.gameplayStart,
                    t[p.Z.tracking.screen.gameplayStop] = p.Z.tracking.screen.gameplayStop,
                    t[p.Z.tracking.screen.commercialBreak] = p.Z.tracking.screen.commercialBreak,
                    t[p.Z.tracking.screen.rewardedBreak] = p.Z.tracking.screen.rewardedBreak,
                    t);
                ...
                e.setupObserver = function() {
                    ...
                    function(e, t, n) {
                        var p = null;
                        try {
                            d(p = c()) ? (p.previous_page.path = p.page.path,
                            ...
                            p.depth = A() + 1,
                            p.expire = Date.now() + 18e5) : p = function(e, t, n) {
                                try {
                    ...
                    E.pokiGTM = E.pokiGTM || [],
                    (0,
                    y.Z)("null.html?https://a.poki.com/observer/t2.js"),
                    e.logToObserver = !0
                }
                ,
                e.logToObserver = !1,
        ...
        298: (e,t,n)=>{
            ...
            const o = function() {
                ...
                e.init = function(t, n) {
                    ...
                    void 0 === n && (n = !1)) : (t = !1,
                    void 0 === n && (n = !1))),
                    a.endsWith(".poki-gdn.com") ? (t = !1,
                    n = !1) : "qa-files.poki.com" !== a && "inspector-uploads.poki-user-content.com" !== a || (t = !0,
                    n = !0),
                    i.Z.debugMode && (t = !0),
                    i.Z.logMode && (n = !0),
                    void 0 === n && (n = t),
        ...
        902: (e,t,n)=>{
            ...
            const s = function(e) {
                ...
                if ("undefined" != typeof window && "undefined" != typeof fetch) {
                    ...
                    i.Z.debug ? console.log("PokiAdServer Tracking: ", d) : fetch("null.html?https://t.poki.io/adserver", {
                        method: "POST",
                        mode: "no-cors",
        ...
        if (n[e])
            ...
            if (void 0 !== o)
                for (var c = document.getElementsByTagName("script"), l = 0; l < c.length; l++) {
                    var A = c[l];
                    if (A.getAttribute("src") == e || A.getAttribute("data-webpack") == i + o) {
                        s = A;
                        break
                    }
                }
